...
public class GetJsonLoaiXe extends AsyncTask<Void, Void, Void> {
    Activity activity;
    String url;
    ArrayList<Xe> list = new ArrayList<Xe>();


    public GetJsonLoaiXe(Activity activity, String url, ArrayList<Xe> list) {
        list.clear();
        ...
        if (json != null) {
            try {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    String tenxe = jsonObject.getString("tenloaixe");
                    xe.setIdXe(idxe);
                    xe.setTenXe(tenxe);
                    list.add(xe);
                }
