...
public class GetJsonTrungTamXe extends AsyncTask<Void, Void, Void> {
    Activity activity;
    String url;
    ArrayList<Xe> list = new ArrayList<Xe>();


    public GetJsonTrungTamXe(Activity activity, String url, ArrayList<Xe> list) {
        list.clear();
